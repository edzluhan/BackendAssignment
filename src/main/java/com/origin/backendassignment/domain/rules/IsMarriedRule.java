...
import com.origin.backendassignment.domain.MaritalStatus;
...
public class IsMarriedRule implements Rule {
    @Override
    ...
    public boolean matches(UserProfile profile) {
        return MaritalStatus.MARRIED.equals(profile.getMaritalStatus());
    }
}
